package com.example.wannafly.data.remote.service
...
class GoogleAuthUiClient(
    ...
    suspend fun signInWithIntent(intent: Intent): SignInResultResponse {
    ...
    fun getSignedIntUser(): UserDataResponse? = auth.currentUser?.run {
        UserDataResponse(
            userId = uid,
            username = displayName,
            profileImageUrl = photoUrl?.toString()
